<?php
/*
 * Plugin Name: Axigenio Pixel
 * Plugin URI: https://axigenio.com
 * Description: Add the Axigenio Pixel code in your website header, inside the <head> tag.
 * Version: 1.0
 * Author: AGX
...
if ( !class_exists('AxigenioPixel' ) ) {
  ...
  */
  class AxigenioPixel {
     ...
     */
    function add_admin() {
      add_options_page('Axigenio Pixel', 'Axigenio Pixel', 'manage_options', 'acth_plugin', array( $this, 'plugin_options_page' ) );
    }
...
?>
    <div class="plugin-options">
     <h2><span>Axigenio Pixel</span></h2>
...
?>
            <textarea id="acth_options" name="acth_options[text_string]" rows="3" cols="90"><?php _e( $options['text_string'] );?></textarea>
<?php
    }
...
if( class_exists( 'AxigenioPixel' ) ) {
  ...
  <p>Sorry about that! Plugin <span style='color:blue;font-family:poppins'>axigenio-pixel</span> reports that it was unable to start.</p>
  <p><a href='mailto:support@axigenio.com?subject=Axigenio Pixel%20error&body=What version of Wordpress are you running? Please paste a list of your current active plugins here:'>Please report this error</a>.
